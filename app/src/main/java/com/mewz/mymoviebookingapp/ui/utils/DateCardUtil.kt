...
class DateCardUtil {
    ...
    var dateList = mutableListOf<DateCard>()
    var dateListDateCard = mutableListOf<String>()
    ...
    fun addTimeSlotTODateList(){
        ...
        for (i in 1..14){
            ...
            dateList.add(DateCard(dayOfWeek, month, dayOfMonth.toString(), latestTime))
        ...
        dateList.forEach { it ->
            ...
            dateListDateCard.add(dateString)
        }
    }
